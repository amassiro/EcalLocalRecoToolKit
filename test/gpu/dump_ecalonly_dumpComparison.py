...
process.TreeComparisonProducer = cms.EDAnalyzer('TreeComparisonProducer',
                           ...
                           SecondEcalUncalibRecHitsEBCollection = cms.InputTag("ecalMultiFitUncalibRecHitGpu","EcalUncalibRecHitsEB"),
                           SecondEcalUncalibRecHitsEECollection = cms.InputTag("ecalMultiFitUncalibRecHitGpu","EcalUncalibRecHitsEE"),
                           )
