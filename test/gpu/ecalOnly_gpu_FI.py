...
process.load('sourceFromRawFI_cff')
...
process.ecalUncalibRecHitProducerGPU.shouldTransferToHost = True
process.ecalUncalibRecHitProducerGPU.shouldRunTimingComputation = False
#process.ecalUncalibRecHitProducerGPU.kernelsVersion = 3
# AM:: kernelsVersion --> what does it do?
#
